...
//
//     final pesananDriverModel = pesananDriverModelFromJson(jsonString);

import 'package:meta/meta.dart';
import 'dart:convert';

PesananDriverModel pesananDriverModelFromJson(String str) => PesananDriverModel.fromJson(json.decode(str));

String pesananDriverModelToJson(PesananDriverModel data) => json.encode(data.toJson());

class PesananDriverModel {
  final String status;
  ...
  factory PesananDriverModel.fromJson(Map<String, dynamic> json) => PesananDriverModel(
    status: json["status"],
